lang_dict = {
    ...
    'change lang': ["""Tilni o\'zgartirish 🇺🇿🇷🇺""", """Смена языка 🇺🇿🇷🇺"""],
    
    'change phone number': ["""Telefon raqamni o\'zgartirish 📞""", """Смена номера телефона 📞"""],
    ...
    'my points': ["""Mening ballarim 📈""", """Мои баллы 📈"""],
    ...
    'nura store': ["""Nura store 🏬""", """Nura store 🏬"""],

    'type store title': ["""Mahsulot sotib olingan do'kon nomini kiriting""", """Введите название магазина в котором купили стабилизатор"""],
